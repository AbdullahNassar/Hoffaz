      ...
      <div class="col-md-8 col-md-offset-2">
          <div class="box transparent">
            <div class="box-header border">
              <h3 class="box-title"><span class="semi-bold">تسجيل الانصراف</span></h3>
            ...
            <br>
			<form class="form-1 fl-form" action="{{route('admin.teachers.leave')}}" enctype="multipart/form-data" method="post" onsubmit="return false;">
                {{ csrf_field() }}
				<div class="box-body">
