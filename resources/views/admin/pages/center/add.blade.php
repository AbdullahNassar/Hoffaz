			...
			<div class="col-md-8 col-md-offset-2">
				<div class="box transparent">
					<div class="box-header border">
						<h3 class="box-title"><span class="semi-bold">اضافة مركز جديد</span></h3>
					...
					<div class="box-body" style="display: block;">
						<form class="form-1 fl-form" action="{{route('admin.centers.add')}}" enctype="multipart/form-data" method="post" onsubmit="return false;">{{ csrf_field() }}
							<div class="row form-row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input name="manager" class="form-control" id="input-2" type="text">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="input-3">اسم المدير العام</label>
										<input name="head_manager" class="form-control" id="input-3" type="text">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
